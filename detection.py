...
def sample_selection(df):
    try:
        ...
        print('exception_type_warning')
    else:
        print('exception_type_ok')
# 跟车距离检测
    try:
        t1 = time.time()
    ...
    try:
        ...
        if len(lane_departure_samples) > 0:
            ...
            if not os.path.getsize(video_pos_path) and os.path.getsize(picture_pos_path) != 0:  ###没有视频
                ...
                # Second_det_lane_departure_video =[4] * length
                ...
                # Second_det_lane_departure = [4] * length
            ...
            for index, row in lane_departure_samples.iterrows():
                ...
                if ((Second_det_lane_departure[a] == 1 or Second_det_lane_departure_video[a] == 1) and t_type in [5,6]) or ((
                    Second_det_lane_departure[a] == 2 or Second_det_lane_departure_video[a] == 2) and t_type in [3, 4]):
